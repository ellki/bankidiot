...
class Bank:
    ...
    #Konstruktor:
    def __init__(self):
        self._customers = {} #Dictionary med Kunder:Kundnummer
        self._accounts = {} #Dictinary med Kontonnummer:Konto (saldo?)
    ...
    def add_customer(self, name: str, personal_nbr: str) -> str: # or None:
        ...
        if personal_nbr in self._customers.values():
            return None
        else:
